  ...
  configure(consumer: MiddlewareConsumer) {
    ...
    consumer
      ...
      .forRoutes(
        ...
        { path: 'doctors/workplaces/:workplaceId/availability', method: RequestMethod.PUT },
        ...
        { path: 'doctors/workplaces/:workplaceId/appointment-slots', method: RequestMethod.DELETE },
        { path: 'doctors/workplaces/:workplaceId/appointment-slots/status', method: RequestMethod.PUT },
        ...
        { path: 'doctors/specializations/:specialization', method: RequestMethod.GET },
        { path: 'doctors/specializations/debug/all', method: RequestMethod.GET },
        { path: 'doctors/workplaces/:workplaceId/available-slots', method: RequestMethod.GET },
