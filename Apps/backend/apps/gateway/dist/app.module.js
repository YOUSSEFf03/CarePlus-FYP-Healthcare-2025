...
let AppModule = class AppModule {
    configure(consumer) {
        consumer
            ...
            .exclude('auth/login', 'auth/register', 'auth/refresh-token', 'auth/verify-otp', 'auth/resend-otp', 'auth/forgot-password', 'auth/reset-password', 'auth/register/assistant', { path: 'doctors', method: common_2.RequestMethod.GET }, { path: 'doctors/stats', method: common_2.RequestMethod.GET }, { path: 'doctors/:id', method: common_2.RequestMethod.GET }, { path: 'doctors/:id/reviews', method: common_2.RequestMethod.GET }, { path: 'doctors/:id/available-slots', method: common_2.RequestMethod.GET }, { path: 'doctors/:id/stats', method: common_2.RequestMethod.GET })
