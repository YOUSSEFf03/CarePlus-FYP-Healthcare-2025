...
let AppModule = class AppModule {
    configure(consumer) {
        consumer.apply(auth_middleware_1.AuthMiddleware).forRoutes({ path: 'auth/profile', method: common_2.RequestMethod.GET }, { path: 'auth/profile', method: common_2.RequestMethod.PUT }, { path: 'doctors/workplaces', method: common_2.RequestMethod.GET }, { path: 'doctors/workplaces', method: common_2.RequestMethod.POST }, { path: 'doctors/workplaces/:workplaceId', method: common_2.RequestMethod.PUT }, { path: 'doctors/workplaces/:workplaceId', method: common_2.RequestMethod.DELETE }, {
            ...
            path: 'doctors/workplaces/:workplaceId/assistants/:assistantId',
