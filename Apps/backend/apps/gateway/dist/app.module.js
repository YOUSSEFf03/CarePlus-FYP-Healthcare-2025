...
let AppModule = class AppModule {
    configure(consumer) {
        consumer
            ...
            .forRoutes({ path: 'auth/profile', method: common_2.RequestMethod.GET }, { path: 'auth/profile', method: common_2.RequestMethod.PUT }, { path: 'doctors/workplaces', method: common_2.RequestMethod.GET }, { path: 'doctors/workplaces', method: common_2.RequestMethod.POST }, { path: 'doctors/workplaces/:workplaceId', method: common_2.RequestMethod.PUT }, { path: 'doctors/workplaces/:workplaceId', method: common_2.RequestMethod.DELETE }, { path: 'doctors/workplaces/:workplaceId/assistants', method: common_2.RequestMethod.GET }, { path: 'doctors/workplaces/:workplaceId/assistants', method: common_2.RequestMethod.POST }, { path: 'doctors/workplaces/:workplaceId/assistants/:assistantId', method: common_2.RequestMethod.DELETE }, { path: 'doctors/workplaces/:workplaceId/appointment-slots', method: common_2.RequestMethod.GET }, { path: 'doctors/workplaces/:workplaceId/appointment-slots', method: common_2.RequestMethod.POST }, { path: 'doctors/appointments', method: common_2.RequestMethod.GET }, { path: 'doctors/appointments/me', method: common_2.RequestMethod.GET }, { path: 'doctors/analytics/monthly', method: common_2.RequestMethod.GET }, { path: 'doctors/appointments/statistics', method: common_2.RequestMethod.GET }, { path: 'doctors/profile/me', method: common_2.RequestMethod.GET }, { path: 'doctors/profile/me', method: common_2.RequestMethod.PUT }, { path: 'notifications', method: common_2.RequestMethod.GET }, { path: 'notifications', method: common_2.RequestMethod.POST }, { path: 'assistants', method: common_2.RequestMethod.GET }, { path: 'assistants', method: common_2.RequestMethod.POST }, { path: 'assistants/doctor/my-assistants', method: common_2.RequestMethod.GET }, { path: 'assistants/doctor/pending-invites', method: common_2.RequestMethod.GET }, { path: 'assistants/doctor/invite', method: common_2.RequestMethod.POST }, { path: 'assistants/doctor/invites/:inviteId', method: common_2.RequestMethod.DELETE }, { path: 'assistants/doctor/remove-assistant', method: common_2.RequestMethod.DELETE }, { path: 'pharmacy/orders', method: common_2.RequestMethod.GET }, { path: 'pharmacy/orders', method: common_2.RequestMethod.POST });
    }
};
